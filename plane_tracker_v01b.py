...
class App:
    ...
    def run(self):
        while True:
            ...
            pts1 = np.float32([[0,0],[0,720],[1280,720],[1280,0]])
            ...
            if playing:
                ...
                for tr in tracked:
                    ...
                    #fw1=str(xt1)+' '+str(720-yt1)+'\n'
                    #ft1.write(fw1)                    
                    #ft1.close
                    #ft2 = open("track_02.txt", "a")
                    #fw2=str(xt2)+' '+str(720-yt2)+'\n'
                    #ft2.write(fw2)                    
                    #ft2.close
                    #ft3 = open("track_03.txt", "a")
                    #fw3=str(xt3)+' '+str(720-yt3)+'\n'
                    #ft3.write(fw3)                    
                    #ft3.close
                    #ft4 = open("track_04.txt", "a")
                    #fw4=str(xt4)+' '+str(720-yt4)+'\n'
                    #ft4.write(fw4)                    
                    #ft4.close
                    ...
                    dst = cv2.warpPerspective(img_fg,M,(1280,720))                    
                    dstM = cv2.warpPerspective(mask,M,(1280,720))
